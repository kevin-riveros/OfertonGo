...
public class MapsFragment extends Fragment implements OnMapReadyCallback, LocationListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        AndroidNetworking.get("http://ofertongo.gear.host/api/Locations")
        ...
        gMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Intent intent = new Intent(getContext(), PromotionActivity.class)
                        .putExtra("idStore",(int)marker.getZIndex());
    ...
    private void pintarBussinesPoints(List<Location> bussinesPoints) {
        ...
        for (int i = 0; i < bussinesPoints.size(); i++) {
            ...
            markerOptions.zIndex(bussinesPoints.get(i).getId_store());
    ...
    private void drawMarkerUser(LatLng point){
        ...
        /*
    private void drawMarkerB(LatLng point){

        MarkerOptions markerOptions;
        markerOptions= new MarkerOptions();
        markerOptions.position(point).icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_yellow_sale));
        gMap.addMarker(markerOptions);
    }
    */
